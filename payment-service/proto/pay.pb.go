...
func (*PayRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_7b6be5053abae28d, []int{0}
}
...
func (*PayResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_7b6be5053abae28d, []int{1}
}
...
func init() { proto.RegisterFile("proto/pay.proto", fileDescriptor_pay_7b6be5053abae28d) }

var fileDescriptor_pay_7b6be5053abae28d = []byte{
